...
<div class="item-options right">
	<form class="element-form" method="POST" action="<?php echo AJAX_URL; ?>">
		...
		<?php if(is_user_logged_in()) { ?>
			...
			<a href="#" title="<?php _e('Remove from Favorites', 'makery'); ?>" class="element-submit primary active" data-title="<?php _e('Tambah Ke Favorit', 'makery'); ?>"><span class="fa fa-heart small"></span></a>
			<input type="hidden" name="user_action" class="toggle" value="remove_relation" data-value="add_relation" />
			<?php } else { ?>
			<a href="#" title="<?php _e('Add to Favorites', 'makery'); ?>" class="element-submit primary" data-title="<?php _e('Hapus Ke Favorit', 'makery'); ?>"><span class="fa fa-heart small"></span></a>
			<input type="hidden" name="user_action" class="toggle" value="add_relation" data-value="remove_relation" />
			<?php } ?>
		<?php } else { ?>
			<a href="<?php echo ThemexCore::getURL('register'); ?>" title="<?php _e('Tambah Ke Favorit', 'makery'); ?>" class="primary"><span class="fa fa-heart small"></span></a>
		<?php } ?>
		<?php } ?>
