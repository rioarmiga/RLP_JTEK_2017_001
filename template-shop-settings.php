...
<div class="column fivecol">
	...
	<span class="secondary"><?php _e('Tok Ini Tidak Tersedia.', 'makery'); ?></span>
	...
	<?php } ?>
		...
		<?php if(ThemexShop::$data['status']=='draft') { ?>
			...
			<?php } else { ?>
			<a href="#" class="element-button element-submit primary"><?php _e('Kirm Untuk Direview', 'makery'); ?></a>
			<?php } ?>		
		<?php } else { ?>
		<a href="#" class="element-button element-submit primary"><?php _e('Simpan Perubahan', 'makery'); ?></a>
		...
		<div id="remove_form">
			<div class="site-popup small">
				<form class="site-form" method="POST" action="">
					<p><?php _e('Apakah Anda Yakin Untuk Menghapus Toko Ini Secara Permanen?', 'makery'); ?></p>
