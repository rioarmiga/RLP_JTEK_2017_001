...
<div class="column fivecol">
	...
	<p class="secondary"><?php _e('Belum Ada Item Yang Dibuat.', 'makery'); ?></p>
	<?php } else { ?>
	...
	<a href="<?php echo ThemexCore::getURL('shop-product'); ?>" class="element-button primary"><?php _e('Tambah Item', 'makery'); ?></a>
	<?php } ?>
</div>
