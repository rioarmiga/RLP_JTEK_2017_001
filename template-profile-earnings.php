...
<div class="column fivecol">
	<div class="element-title indented">
		<h1><?php _e('Pendapatan', 'makery'); ?></h1>
	</div>
	...
	<span class="secondary"><?php _e('Halam tidak ditemukan', 'makery'); ?></span>
	<?php 
	} else {
