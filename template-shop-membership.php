...
<div class="column fivecol">
	<div class="element-title indented">
		<h1><?php _e('Toko Pedagang', 'makery'); ?></h1>
	</div>
	...
	<span class="secondary"><?php _e('Maaf, toko ini tidak tersedia', 'makery'); ?></span>
	<?php 
	} else {
	...
	<table class="profile-fields">
		<tbody>
			<tr>
				<th><?php _e('Anggota', 'makery'); ?></th>
				<td><?php echo $membership['title']; ?></td>
			</tr>
			<tr>
				<th><?php _e('Berakhir', 'makery'); ?></th>
