...
<div class="column fivecol">
	<div class="element-title indented">
		<h1><?php _e('Ubah Order', 'makery'); ?></h1>
	</div>
	...
	<span class="secondary"><?php _e('Orderan Tidak Tersedia.', 'makery'); ?></span>
	<?php } else { ?>
	<form action="" method="POST" class="site-form">
			...
			<tbody>
				<tr>
					...
					<td>
						...
						<strong><?php _e('Nomor HP:', 'makery'); ?></strong>&nbsp;<?php echo $order['phone']; ?>
						<?php } ?>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<th><?php _e('Pesan Pelanggan', 'makery'); ?></th>
					<td>
		...
		<div class="field-wrap">
			<textarea name="order_note" id="order_note" cols="30" rows="5" placeholder="<?php _e('Catatan Note', 'makery'); ?>"></textarea>
		</div>
		<?php } ?>
		<a href="#" class="element-button element-submit primary"><?php _e('Pesan', 'makery'); ?></a>
