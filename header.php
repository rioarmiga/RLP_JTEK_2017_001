		...
		<div class="header-wrap clearfix">
			<header class="site-header container">
				...
				<div class="header-options right clearfix">
					...
					<a href="<?php echo ThemexCore::getURL('register'); ?>" class="element-button primary"><?php _e('Buat Akun','makery'); ?></a>
					<?php } ?>					
							...
							<div class="site-popup small">
								<form class="site-form element-form" method="POST" action="<?php echo AJAX_URL; ?>">
									<div class="field-wrap">
										<input type="text" name="user_login" value="" placeholder="<?php _e('Nama', 'makery'); ?>" />
									</div>
									<div class="field-wrap">
						...
						<div id="password_form">
							<div class="site-popup small">
								<form class="site-form element-form" method="POST" action="<?php echo AJAX_URL; ?>">
									...
									<a href="#" class="element-button element-submit primary"><?php _e('Atur Ulang Kata Sandi', 'makery'); ?></a>
